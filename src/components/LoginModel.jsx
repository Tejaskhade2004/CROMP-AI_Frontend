...
function LoginModel({ open, onClose }) {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      // Store user data in Redux so the UI updates immediately
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120x_rgba(0,0,0,0.8)] overflow-hidden'>
            ...
            <div className='relative px-8 pt-14 pb-10 text-center'>
              ...
              <h2 className='text-3xl font-semibold leading-tight mb-3 space-x-2'>
                ...
                <span className='bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent'>CROMP.AI</span>
              </h2>
              ...
              >
                ...
                <div className='relative flex items-center justify-center gap-3'>
                  <img src="https://commons.wikimedia.org/wiki/File:Google_%22G%22_logo.svg" alt=""
                    className='h-5 w-5'
                  />
